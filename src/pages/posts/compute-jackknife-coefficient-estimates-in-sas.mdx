...
bias, which produces the **_Jackknifed_** coefficient estimates for each
observation.
...
| <div style="width:12rem">Variable</div>                     | Definition                                                                                                     |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
...
| Variable     | Option in `PROC REG` or `MODEL` statement                        | Name in output      |
| ------------ | ---------------------------------------------------------------- | ------------------- |
