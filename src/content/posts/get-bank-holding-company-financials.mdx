---
title: Get Bank Holing Company Financials from FR Y-9C
pubDate: May 25, 2020
tags:
- SAS
- Code
...
[mingze-gao.com/data/download/crsp_20181231.csv](https://mingze-gao.com/data/download/crsp_20181231.csv).
...
<Aside type="note">
  Please run these programs on the WRDS cloud. You'll need to modify them in
  order to run locally with SAS/Connect.
</Aside>
