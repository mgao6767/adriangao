...
[Stata](https://www.stata.com) is a powerful statistical analysis software that we often use in empircal researches. This series of posts aims to provide some basic knowledge for junior researchers to get started with Stata, as well as some personal tips on more efficiently using Stata in research projects.[^1]

[^1]: I prepare this series of introductory course notes for the BUSS7902 Quantitative Business Research Methods for the PhD and MPhil students at the University of Sydney Business School in Semester 1, 2023.
...
![stata-gui](/images/stata/gui.png)
...
![sysuse_auto](/images/stata/sysuse_auto.png)
...
![reg_price](/images/stata/reg_price.png)
...
![putdocx](/images/stata/putdocx.png)
...
<Aside type="note">
  ...
  I deliberately make them oversimplified only to show you what Stata can do in making ourlives much easier.
</Aside> 

<Aside type="tip" title="Next section">
  [Stata 101 - Packages](/posts/stata-101-packages).
</Aside>